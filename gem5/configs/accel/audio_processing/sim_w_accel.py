...
system.accel.compute_unit = ImageProcessingUnit(latency="5us") # Eyeriss
system.accel.energy_per_cycle = [Float(0.0), Float(1.6), Float(8), Float(8)] # Eyeriss
# system.accel.compute_unit = ImageProcessingUnit(latency="48us") # Latice FPGA
# system.accel.energy_per_cycle = [Float(0.0), Float(0.2), Float(12), Float(2.1)] # Latice
