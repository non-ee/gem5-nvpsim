...
- 324: total MAC in 8x8 CNN
  (Output size _ kernel size = 36 _ 9 = 324)

let e_MAC = 1.5 pJ
E_comp = 324 x 1.5p = 486p = 0.486 nJ
...
- Write output: 36
- Let it `e_MEM` = 0.4 nJ
- Total DRAM Energy: E_DRAM = (64 + 9 + 36) x 0.4 = 43.6 nJ

#### GLB: Global Buffer (Large on-chip SRAM)

- Similar to DRAM, read input/weight, write output
- Let it consumes 10x more than RF
- Total GLB Energy: E_GLB = (64 + 9) x 1p + 36 x 0.625p = 131.5p = 0.13 nJ
- Total GLB Latency: T_GLB = 109 x 5n = 545n = 0.55 us
...
- Total RF Energy: E_RF = 324 x 3 x 0.01p + 324 x 0.05 = 26p = 0.26 nJ
- Total RF Latency: T_RF = 324 x 4 x 1n = 1296n = 1.3 us

**Hence**: `E_eyeriss` = 0.486n + 0.13n + 0.26n = 0.876 nJ
`T_eyeriss` = 1.62u + 0.55u + 1.3u = 3.47 us
...
`energy_active` = P*active * ClockCycle = 57m \_ 1u = 57 nJ/cycle
...
`P_active` = P*static + P_dynamic
`energy_active` = P_active * CyclePeriod
`energy_idle` = P*static * CyclePeriod
